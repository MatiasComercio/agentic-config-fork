...
```bash
/spawn low-tier "Run: uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/gmail.py list --limit 10"
/spawn low-tier "Run: uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/gcalendar.py list-events --days 7 --json"
```
...
1. Run: uv run ${CLAUDE_PLUGIN_ROOT}/skills/gsuite/tools/gmail.py search 'from:user@example.com' --json --limit 10

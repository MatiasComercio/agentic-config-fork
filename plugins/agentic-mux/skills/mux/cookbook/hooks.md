...
Defined in `${CLAUDE_PLUGIN_ROOT}/skills/mux/SKILL.md` frontmatter. Uses external script: `mux-orchestrator-guard.py`.
...
- `${CLAUDE_PLUGIN_ROOT}/skills/mux/*` -- skill files, agents, cookbooks
...
BASH_WHITELIST_PATTERNS = [
    ...
    r"^uv\s+run\s+\${CLAUDE_PLUGIN_ROOT}/skills/mux/tools/",  # MUX skill tools
]
```

## MUX Subagent Hooks (mux-subagent.md)

Defined in `${CLAUDE_PLUGIN_ROOT}/skills/mux-subagent/SKILL.md` frontmatter. Uses external script: `mux-subagent-guard.py`.
...
|--------|----------|-------|
| `mux-orchestrator-guard.py` | `${CLAUDE_PLUGIN_ROOT}/skills/mux/hooks/` | Orchestrator only (via mux.md frontmatter) |
| `mux-subagent-guard.py` | `${CLAUDE_PLUGIN_ROOT}/skills/mux-subagent/hooks/` | Subagents only (via mux-subagent.md frontmatter) |

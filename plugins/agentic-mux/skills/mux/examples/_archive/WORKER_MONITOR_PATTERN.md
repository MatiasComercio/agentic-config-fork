...
See `$PROJECT_ROOT/${CLAUDE_PLUGIN_ROOT}/skills/mux/examples/monitor_workers.py` for complete implementation.
...
- **Pattern Implementation:** `$PROJECT_ROOT/${CLAUDE_PLUGIN_ROOT}/skills/mux/examples/monitor_workers.py`
- **Compliance Tests:** `$PROJECT_ROOT/${CLAUDE_PLUGIN_ROOT}/skills/mux/tests/compliance/test_worker_monitor.py`
- **Polling Tool:** `$PROJECT_ROOT/${CLAUDE_PLUGIN_ROOT}/skills/mux/tools/poll-signals.py`
- **Task Manager:** `$PROJECT_ROOT/${CLAUDE_PLUGIN_ROOT}/skills/mux/a2a/task-manager.py`

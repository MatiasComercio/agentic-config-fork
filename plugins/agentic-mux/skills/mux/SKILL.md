...
- ${CLAUDE_PLUGIN_ROOT}/skills/mux/tmp/mux/<session>/research/001-topic.md
- ${CLAUDE_PLUGIN_ROOT}/skills/mux/tmp/mux/<session>/audit/001-analysis.md
...
uv run ${CLAUDE_PLUGIN_ROOT}/skills/mux/tools/signal.py $PATH --status success      # Create signal

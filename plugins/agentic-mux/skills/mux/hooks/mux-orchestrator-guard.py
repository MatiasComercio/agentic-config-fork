...
READ_ALLOWLIST_PATTERNS = [
    r"\${CLAUDE_PLUGIN_ROOT}/skills/mux/",  # Skill files, agents, cookbooks
    r"\${CLAUDE_PLUGIN_ROOT}/skills/mux-subagent",  # Subagent skill
    r"plugins/cache/.*/skills/mux-subagent",  # Plugin cache subagent skill
...
SEARCH_ALLOWLIST_PATTERNS = [
    r"\${CLAUDE_PLUGIN_ROOT}/skills/",  # Skill discovery (plugin)
    r"plugins/cache/.*/skills/",  # Skill discovery (plugin cache)

...
Bash("uv run ${CLAUDE_PLUGIN_ROOT}/skills/mux/tools/session.py 'mux-ospec-feature-auth'")
...
# Safety check:
# Bash(f"uv run ${CLAUDE_PLUGIN_ROOT}/skills/mux/tools/verify.py {session}/.signals --action summary")
```

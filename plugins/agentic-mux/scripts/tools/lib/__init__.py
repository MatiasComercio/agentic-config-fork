...
def load_stage_config(config_name: str, script_dir: Path | None = None) -> dict:
    """Load stage configuration from ${CLAUDE_PLUGIN_ROOT}/scripts/tools/config/<name>.json.
...
def load_template(name_or_path: str, script_dir: Path | None = None) -> dict:
    ...
    Otherwise, resolves from ${CLAUDE_PLUGIN_ROOT}/scripts/tools/config/templates/<name>.json.

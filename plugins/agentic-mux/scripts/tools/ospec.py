...
Usage:
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/ospec.py full specs/001-feature.md
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/ospec.py lean specs/001-feature.md
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/ospec.py leanest specs/001-feature.md --max-depth 5

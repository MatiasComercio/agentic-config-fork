...
Usage:
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/oresearch.py --topic "Feature X" --session-dir tmp/session/
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/oresearch.py --topic "Feature X" --session-dir tmp/session/ --domains market,tech
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/oresearch.py --topic "Feature X" --session-dir tmp/session/ --refinement-context path/to/refinement.md
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/oresearch.py --topic "Feature X" --session-dir tmp/session/ --max-depth 5

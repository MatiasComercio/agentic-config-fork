...
Usage:
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/coordinator.py config.json
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/coordinator.py config.json --max-depth 5
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/coordinator.py config.json --session-dir /path/to/session

...
Usage:
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spec.py RESEARCH specs/2026/02/branch/001-feature.md
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spec.py PLAN specs/2026/02/branch/001-feature.md --focus "auth module"
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spec.py IMPLEMENT specs/2026/02/branch/001-feature.md --model high-tier
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/spec.py RESEARCH specs/001.md --max-depth 3
...
def find_project_root(start: Path) -> Path | None:
    """Walk up from start to find the project root containing ${CLAUDE_PLUGIN_ROOT}/commands/claude/spec.md."""
    current = start

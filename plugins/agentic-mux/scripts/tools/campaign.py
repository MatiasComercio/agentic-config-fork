...
Usage:
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/campaign.py --topic "Feature X"
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/campaign.py --topic "Feature X" --session-dir tmp/session/
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/campaign.py --topic "Feature X" --phase PLAN
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/campaign.py --topic "Feature X" --phase EXECUTE --session-dir tmp/session/
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/campaign.py --topic "Feature X" --resolution path/to/ceo-feedback.md --session-dir tmp/session/
...
def run_decompose(
    ...
    prompt = (
        ...
        f'"phases": ['
        f'{{"name": "phase-01-...", "orchestrator": "${CLAUDE_PLUGIN_ROOT}/scripts/tools/ospec.py", '

...
Usage:
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/researcher.py --domain market --topic "Feature X" --output findings.md
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/researcher.py --domain ux --topic "Feature X" --output findings.md
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/researcher.py --domain tech --topic "Feature X" --output findings.md
    uv run ${CLAUDE_PLUGIN_ROOT}/scripts/tools/researcher.py --domain market --topic "Feature X" --output findings.md --model high-tier

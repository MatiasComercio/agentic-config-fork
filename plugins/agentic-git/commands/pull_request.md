---
description: Create comprehensive GitHub Pull Request with authentication validation
argument-hint: [target_branch] [gh_user]
...
## Usage
```
/pull_request [target_branch] [gh_user]
```
...
**Examples**:
```
/pull_request                    # Uses main, $GH_USER
/pull_request master             # Target master branch
/pull_request main my-username   # Explicit user override
```
...
Please specify correct target: /pull_request <branch>
```

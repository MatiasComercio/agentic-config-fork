...
test -f ${CLAUDE_PLUGIN_ROOT}/agents/spec-command.md && echo "✓ Target exists"
cat ${CLAUDE_PLUGIN_ROOT}/agents/spec-command.md | head -3
```
...
✓ .claude/commands/spec.md → ${CLAUDE_PLUGIN_ROOT}/commands/claude/spec.md
✓ .gemini/commands/spec.toml → ${CLAUDE_PLUGIN_ROOT}/commands/gemini/spec.toml
...
CRITICAL: Broken symlink
   ...
   Fix: rm .codex/prompts/spec.md && \
        ...
        ln -s ${CLAUDE_PLUGIN_ROOT}/agents/spec-command.md .codex/prompts/spec.md

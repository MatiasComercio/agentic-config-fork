...
### Deferred surface
- Strict sibling alignment for `ac-workflow-mux` and `ac-workflow-mux-roadmap` remains deferred to later IT005 phases.
...
- Phase 004/005 now ship the strict runtime seam plus canonical strict `mux-ospec` consumption; sibling `mux` / `mux-roadmap` strict alignment remains deferred to later IT005 phases.

...
FILE_QUEUE = PROJECT_ROOT / ".pi" / "extensions" / "pimux" / "file-queue.ts"
REGISTRY_RUNTIME = PROJECT_ROOT / ".pi" / "extensions" / "pimux" / "registry.ts"
BRIDGE_RUNTIME = PROJECT_ROOT / ".pi" / "extensions" / "pimux" / "bridge.ts"
